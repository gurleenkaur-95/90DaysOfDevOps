...
- Issue I faced: scp gave the error “No such file or directory” because nginx-logs.txt had not been created on the EC2 server.  
Solution I used: I created the log file using: journalctl -u nginx > ~/nginx-logs.txt  
